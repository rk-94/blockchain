...
var invokeChaincode = async function(peerNames, channelName, chaincodeName, fcn, args, username, org_name) {
	...
	try {
		...
		for (var i in proposalResponses) {
			...
			if (proposalResponses && proposalResponses[i].response &&
				...
				response_message = proposalResponses;
		...
		if (all_good) {
			...
			var url = "http://rdctstbc001:5984/mychannel_mycc/"+proposalResponses[0].response.payload;
	...
	if (!error_message) {
		...
		response_message = JSON.parse(body)._rev;
		console.log( "Returned CouchDB hash is " +response_message);
	...
	logger.debug("response message is -- "+response_message);
